...
- Project links support App Store and Google Play store icons. Google Play links should use `type: "Google Play"` and the runtime icon at `public/assets/icons/google-play-icon.png`.
